...
class TeamService
{
    ...
    public function createItem($request)
    {
        $validator = Validator::make($request->all(),[
            ...
            'designation'            => 'required|string|min:2|max:200',
            ...
            'designation.string'     => 'designation must be string',
            'designation.min'        => 'designation minimum length 2',
            'designation.max'        => 'designation maximum length 200',
        ...
        try {
            ...
            if($request->hasFile('media')) {
                ...
                $imageUrl           = Helper::base64BannerStore("uploads/avatar/", $request->media);
