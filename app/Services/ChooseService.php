...
class ChooseService
{
    ...
    public function __construct(ChooseRepository $repository)
    {
    ...
    public function createItem($request)
    {
        ...
        $validator = Validator::make($request->all(),[
            ...
            'title'                  => 'required|string|min:3|max:100|unique:services',
        ...
        try {
            ...
            if($request->hasFile('media')) {
                ...
                $imageUrl           = Helper::base64IconStore("uploads/icons/", $request->media);
